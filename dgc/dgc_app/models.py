...
class app_details(models.Model):
    ...
    apartment_mail = models.EmailField(unique=True)
...
class admin_details(models.Model):
    ...
    status = models.CharField(max_length=50, choices=[('verified', True), ('unverified', False)], default='unverified')
    username = models.CharField(max_length=100)
    password = models.CharField(max_length=100)
    show_visitors = models.CharField(max_length=50, choices=[('yes', True), ('No', False)], default='No')
    ...
    show_tickets = models.CharField(max_length=50, choices=[('Yes', True), ('No', False)], default='No')
    ...
    show_event= models.CharField(max_length=50, choices=[('Yes', True), ('No', False)], default='No')
    ...
    show_amenties = models.CharField(max_length=50, choices=[('Yes', True), ('No', False)], default='No')
    show_elevator = models.CharField(max_length=50, choices=[('Yes', True), ('No', False)], default='No')
    show_maintenances = models.CharField(max_length=50, choices=[('Yes', True), ('No', False)], default='No')
    ...
    show_attendance = models.CharField(max_length=50, choices=[('Yes', True), ('No', False)], default='No')
    ...
    cctv = models.CharField(max_length=50, choices=[('Yes', True), ('No', False)], default='No')
    cctv_selected_days = models.CharField(max_length=100, choices=days_selects, default=last10days)
    cctv_live_or_not = models.CharField(max_length=50, choices=[('Yes', True), ('No', False)], default='No')
    show_housevacant = models.CharField(max_length=50, choices=[('Yes', True), ('No', False)], default='No')
    housevacant_selected_block = models.CharField(max_length=100, default="block-1")
    show_guesthousevacant = models.CharField(max_length=50, choices=[('Yes', True), ('No', False)], default='No')
    guesthousevacant_selected_block = models.CharField(max_length=100, default="block-1")
    show_alert_and_sos = models.CharField(max_length=50, choices=[('Yes', True), ('No', False)], default='No')
    alert_and_sos_selected_block = models.CharField(max_length=100, default="block-1")
    show_medical_struck = models.CharField(max_length=50, choices=[('Yes', True), ('No', False)], default='No')
    medical_struck_selected_block = models.CharField(max_length=100, default="block-1")
    show_residence_details = models.CharField(max_length=50, choices=[('Yes', True), ('No', False)], default='No')
    residence_selected_block = models.CharField(max_length=100, default="block-1")
    show_inventory = models.CharField(max_length=50, choices=[('Yes', True), ('No', False)], default='No')
